<!doctype html>
<html lang="pt-br" class="h-64 w-full h-full" style="background: linear-gradient(90deg, #11b1fe, #0f56c2);">
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Login Scoma</title>
...
@auth
    <div class="min-h-full">
        <nav style="background: linear-gradient(90deg, #11b1fe, #0f56c2);">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="size-10 w-auto" src="https://duquedecaxias.rj.gov.br/images/dc-logo.png" alt="Your Company">
                        </div>
                            ...
                            <div class="relative ml-3" x-data="{ open: false }">
                                ...
                                <div>
                                    <button
                                        ...
                                        aria-haspopup="true"
                                        @click="open = !open"
                                        @mouseover="if (window.innerWidth >= 768) open = true"
                                    >
                                        <span class="absolute -inset-1.5"></span>
